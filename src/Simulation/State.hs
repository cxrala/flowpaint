...
-- -- *** old pigment behaviour begin ***
-- getSurfaceLayer :: Color -> State -> ScalarField
-- getSurfaceLayer _ = surfaceLayerDensity
-- -- *** old pigment behaviour end ***
...
initialState sizeN =
  let dims = dimsFromN sizeN
   ...
   in State
        ...
        -- -- *** old pigment behaviour begin ***
        -- , pigmentDensity = initialMat
        -- , surfaceLayerDensity = initialMat
        -- -- *** old pigment behaviour end ***
 ...
 =
  let n = canvasSize prevState
   ...
   in prevState
        ...
        , pigLayers = sourceUpdatedPigLayer
